...
main(int argc, char *argv[]) {
    ...
    cmd.AddValue("delay", "Delay value", delay);
    cmd.AddValue("ber", "Bit Error rate", ber);
    cmd.AddValue("tcp variant", "TCP variant name", tcp_variant);
    ...
    app->Setup (ns3TcpSocket, sinkAddress, 1040, 1000, DataRate ("20Mbps"));
